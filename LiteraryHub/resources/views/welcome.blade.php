<x-guest2-layout>
    ...
    <div class="py-5 flex justify-center flex-wrap">
        ...
        <div
          class="mx-3 my-2 flex flex-col rounded-lg bg-white shadow-lg dark:bg-neutral-700 md:max-w-xl md:flex-row shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
          <img
          ...
          <ul class="mt-8 mr-3 flex justify-center">
            <li>
              <svg
