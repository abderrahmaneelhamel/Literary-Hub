                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="topbar-links">
                                    <a href="{{ url('/signin') }}"><i class="fa fa-lock"></i>Login / Register</a>
                                    <span>|</span>
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ url('/') }}">Home V1</a></li>
                                    <li><a href="{{ url('/home-v2') }}">Home V2</a></li>
                                    <li><a href="{{ url('/home-v3') }}">Home V3</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a data-toggle="dropdown" class="dropdown-toggle disabled" href="{{ url('/books-media-list-view') }}">Books &amp; Media</a>
                                <ul class="dropdown-menu">
                                    <li><a href="{{ url('/books-media-list-view') }}">Books &amp; Media List View</a></li>
                                    <li><a href="{{ url('/books-media-gird-view-v1') }}">Books &amp; Media Grid View V1</a></li>
                                    <li><a href="{{ url('/books-media-gird-view-v2') }}">Books &amp; Media Grid View V2</a></li>
                                    <li><a href="{{ url('/books-media-detail-v1') }}">Books &amp; Media Detail V1</a></li>
                                    <li><a href="{{ url('/books-media-detail-v2') }}">Books &amp; Media Detail V2</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a data-toggle="dropdown" class="dropdown-toggle disabled" href="{{ url('/news-events-list-view') }}">News &amp; Events</a>
                                <ul class="dropdown-menu">
                                    <li><a href="{{ url('/news-events-list-view') }}">News &amp; Events List View</a></li>
                                    <li><a href="{{ url('/news-events-detail') }}">News &amp; Events Detail</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                            ...
                            <li class="dropdown">
                                <a data-toggle="dropdown" class="dropdown-toggle disabled" href="{{ url('/blog') }}">Blog</a>
                                <ul class="dropdown-menu">
                ...
                <div id="mobile-menu">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="{{ url('/index-2') }}">Home V1</a></li>
                                <li><a href="{{ url('/home-v2') }}">Home V2</a></li>
                                <li><a href="{{ url('/home-v3') }}">Home V3</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ url('/books-media-list-view') }}">Books &amp; Media</a>
                            <ul>
                                <li><a href="{{ url('/books-media-list-view') }}">Books &amp; Media List View</a></li>
                                <li><a href="{{ url('/books-media-gird-view-v1') }}">Books &amp; Media Grid View V1</a></li>
                                <li><a href="{{ url('/books-media-gird-view-v2') }}">Books &amp; Media Grid View V2</a></li>
                        ...
                        <li>
                            <a href="{{ url('/news-events-list-view') }}">News &amp; Events</a>
                            <ul>
                                <li><a href="{{ url('/news-events-list-view') }}">News &amp; Events List View</a></li>
                                <li><a href="{{ url('/news-events-detail') }}">News &amp; Events Detail</a></li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 pull-right">
                            <ul>
                                ...
                                <li><a href="{{ url('/books-media-list-view') }}">Books &amp; Media</a></li>
                                <li><a href="{{ url('/news-events-list-view') }}">News &amp; Events</a></li>
